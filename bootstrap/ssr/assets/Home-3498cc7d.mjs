...
import { f as faqData, a as Layout } from "./Layout-8810c63e.mjs";
...
const FaqCard = ({ data, index }) => {
  return /* @__PURE__ */ jsx(Grid, { xs: 5, sm: 4, children: /* @__PURE__ */ jsx(
    motion.div,
    {
...
const FaqSection = () => {
  return /* @__PURE__ */ jsxs("div", { className: "container mx-auto", children: [
    ...
    /* @__PURE__ */ jsx(Grid.Container, { gap: 2, justify: "center", children: faqData.map((value, index) => /* @__PURE__ */ jsx(FaqCard, { index, data: value }, index)) })
  ] });
};
const HeroCard = ({ nft }) => {
  var _a, _b, _c;
  ...
  return /* @__PURE__ */ jsx(motion.div, { variants: fadeIn("up", "spring", 0.15, 0.75), children: /* @__PURE__ */ jsx(Tilt, { options: { max: 45, scale: 1, speed: 450 }, children: /* @__PURE__ */ jsxs(
    Card,
    {
      isPressable: true,
      onPress: navigate,
