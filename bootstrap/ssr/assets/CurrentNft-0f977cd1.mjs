...
import { Text, Spacer, Button, Modal, Table, User, Input, Card, Grid } from "@nextui-org/react";
            ...
            /* @__PURE__ */ jsxs(
              Table,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Table.Body, { children: (auction == null ? void 0 : auction.auction_bets) ? auction == null ? void 0 : auction.auction_bets.map((value, index) => /* @__PURE__ */ jsxs(Table.Row, { children: [
...
const BaseAuctionCard = ({
  headerText,
  children
}) => {
  return /* @__PURE__ */ jsx("div", { className: "ml-auto w-full lg:max-w-min", children: /* @__PURE__ */ jsxs(Card, { css: {
    minWidth: "340px",
    borderWidth: "0px"
  }, children: [
    headerText && /* @__PURE__ */ jsx(Card.Header, { children: /* @__PURE__ */ jsx(Text, { children: headerText }) }),
...
const AuctionCard = ({
  ...
  const user = useUser();
  const endDate = new Date((auction == null ? void 0 : auction.end_at) || "");
  ...
  if (!auction)
    ...
    return /* @__PURE__ */ jsx(BaseAuctionCard, { headerText: "Log in to place a bet" });
  else
    return /* @__PURE__ */ jsxs(BaseAuctionCard, { children: [
...
const NftSection = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "container mx-auto", children: /* @__PURE__ */ jsxs(Grid.Container, { gap: 2, justify: "center", children: [
    /* @__PURE__ */ jsx(Grid, { xs: 12, sm: 7, children: /* @__PURE__ */ jsxs("div", { children: [
      ...
      nft.nft_item_tags.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
